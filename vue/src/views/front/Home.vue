                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <div class="card">
                            ...
                            <div style="margin-top: 40px">
                                <el-row :gutter="20">
                                    <el-col :span="12" v-for="item in lostData" :key="item.id" style="margin-bottom: 20px">
                    ...
                    <el-col :span="12">
                        <div class="card">
                            ...
                            <div style="margin-top: 40px">
                                <el-row :gutter="20">
                                    <el-col :span="12" v-for="item in foundData" :key="item.id">
                                        <div class="transition card">
                                            <div style="display: flex">
                                                <img :src="item.img" alt="" style="height: 75px; width: 75px; border: 1px solid #eeeeee; border-radius: 10px">
                                                <div style="margin-left: 10px">
                                                    <div style="font-weight: 550; color: #ef5d26">{{ item.name }}</div>
                                                    <div style="margin-top: 10px; color: #666666">{{ item.userName }}</div>
                                                    <div style="margin-top: 5px; color: #666666">时间：{{ item.time }}</div>
                                                </div>
                                            </div>
                                            <div style="margin-top: 20px">
                                                <el-button type="info" size="mini" @click="viewContent(item.content)">查看详情</el-button>
                                                <el-button type="success" size="mini" @click="contact(item, '招领广场')">联系他</el-button>
                                            </div>
                                        </div>
                                    </el-col>
                                </el-row>
